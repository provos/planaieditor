							...
							>
								...
								<Tooltip.Root delayDuration={400}>
									...
									>
										...
										Pydantic models that flow through the graph as inputs and outputs. This node
										creates a bookmark to open the side panel to add, remove, and edit tasks.
										{#if taskTooltip}
								...
								<Tooltip.Root delayDuration={400}>
									...
									<Tooltip.Content
										...
										side="bottom"
									>
										Import existing Task classes from Python modules to use in your workflow. This
										node creates a bookmark to open the side panel to add, remove, and edit task
										imports.
