...
export async function setupMonacoEnvironment(): Promise<typeof Monaco | null> {
	...
	console.log(
		'Monaco Environment setup will be done by initServices with configureDefaultWorkerFactory.'
	);
	try {
		await initServices(
			{
